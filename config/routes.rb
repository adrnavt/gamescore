ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :newreleases

  map.resources :previews

  map.resources :consolas

  map.resources :reviews

  map.resources :games, :has_many => [:reviews, :previews, :newreleases]
  ...
  map.construccion "/construction", :controller => "publica", :action=>"construccion" 
